...
The comparison uses systemgmmkit as the reference within this artifact. Stata xtabond2 is expected to match closely where the effective sample and instrument conventions are aligned. R package results are reported as auxiliary external-reference notes; strict parity is not assumed unless the underlying model specification and instrument construction are fully aligned.
