...
for start_pos in start_positions:
    print("\n" + "=" * 100)
    print(f"RUNNING FOD START POS: {start_pos}")
    print("=" * 100)
    ...
    stdout_path = OUT / f"fod_start_pos_{start_pos}_stdout.txt"
    stderr_path = OUT / f"fod_start_pos_{start_pos}_stderr.txt"
    ...
    copy_path = OUT / f"fod_start_pos_{start_pos}_coef_comparison.csv"
...
out_path = OUT / "fod_start_pos_grid_summary.csv"
