...
def compare_native_to_stata(oracle: pd.DataFrame) -> pd.DataFrame:
    ...
    native_candidates = {
        ...
        "zrank": ["native_zrank", "native_n_instruments", "zrank", "n_instruments", "instruments", "k_inst", "instrument_count"],
        "chi2_J": ["native_chi2_J", "native_hansen_J", "native_hansen_j_robust", "chi2_J", "hansen_J", "hansen_j_robust"],
        "p_J": ["native_p_J", "native_hansen_p", "native_hansen_p_robust", "p_J", "hansen_p", "hansen_p_robust"],
        "chi2_J_u": ["native_chi2_J_u", "native_hansen_j_stat", "native_sargan_j_stat", "chi2_J_u", "sargan_j", "sargan_stat"],
        "p_J_u": ["native_p_J_u", "native_sargan_p", "p_J_u", "sargan_p", "sargan_pvalue", "sargan_p_value"],
