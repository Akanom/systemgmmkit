...
NATIVE_PARAMS = ART / "specs" / "system_gmm_baseline_controls" / "windmeijer" / "native_params.csv"
NATIVE_DIAG = ART / "specs" / "system_gmm_baseline_controls" / "windmeijer" / "native_diagnostics.csv"

STATA_PARAMS = ART / "system_gmm_fd_twostep_params.csv"
STATA_DIAG = ART / "system_gmm_fd_twostep_diagnostics.csv"

OUT = ART / "system_gmm_fd_twostep_native_vs_xtabond2_coef_comparison.csv"
OUT_DIAG = ART / "system_gmm_fd_twostep_native_vs_xtabond2_diagnostics_comparison.csv"
