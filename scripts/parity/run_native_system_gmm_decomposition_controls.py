...
def main() -> None:
    ...
    if not DATA.exists():
        raise FileNotFoundError(
            ...
            "Run scripts/parity/build_xtabond2_system_gmm_decomposition_controls_do.py first."
        )
        ...
        [
            {
                ...
                "native_ar1": getattr(res, "ar1", None),
                "native_ar1_p": getattr(res, "ar1_p", None),
                "native_ar2": getattr(res, "ar2", None),
    ...
    print("Wrote native System GMM decomposition controls outputs")
